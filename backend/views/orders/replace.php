...
------------------------------------------------------------------------->
        ...
        <div class="form-group">
            <label for="exampleSelect1">Choose Reason</label>
            <select class="form-control" id="replace-reason" name="replacement_id">
        ...
        <br>
        <label id="ptext-label" style="display:none;">Card Comments</label>
        <?= $form->field($model, 'comment')->textInput(['maxlength' => true, 'style' => 'display:none;', 'id' => 'ptext'])->label(false) ?>
