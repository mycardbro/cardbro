...
class Orders extends \yii\db\ActiveRecord
{
    ...
    public function scenarios()
    {
        ...
        $scenarios['new'] = ['token'];//Scenario Values Only Accepted
        return $scenarios;
    }
    ...
    public static function getOrderNumberByProductId($productId)
    {
         $invoices = Invoice::find()->select('id')->where(['product_id' => $productId])->column();

         return self::find()->where(['in', 'invoice_id', $invoices])->count();
    }
}
