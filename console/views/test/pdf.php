...
<table>
    <tr>
        ...
        <td style="padding-left: 250px; margin-top: -50px;">
            <img src="http://cardcompact.outsoft.com/backend/web/images/card_compact_logo.jpg" alt="CardCompact" class="header__logo" align="right">
        </td>
    </tr>
    <tr>
        <td style="display: inline-block; width: 30%; margin-top: -115px;" class="left-column">
            <img src="http://cardcompact.outsoft.com/backend/web/images/MasterCard-logo.jpg" alt="CardCompact" class="left-column__logo">
